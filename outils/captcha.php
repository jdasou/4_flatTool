...
for (
    ...
    imagettftext(
        ...
        ($i - 1) * 30 + 5,
        30,
        imagecolorallocate($img, rand(20, 100), rand(20, 100), rand(20, 100)),
        $font,
        $c
    ); //On ajoute le caractere sur limage
...
for (
    ...
    imageline(
        ...
        rand(0, $x),
        rand(0, $y),
        imagecolorallocate($img, rand(10, 200), rand(10, 200), rand(10, 220))
    ); //On ajoute la ligne
}
