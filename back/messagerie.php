...
if (isset($_SESSION["id_compte"])) {
         ...
         switch ($_GET["cas"]) {
             case "avertir_message":
                 if (isset($_GET["id_contact"])) {
                     $confirmation =
                         "<p>Voulez-vous supprimer le message du contact n°" .
                         $_GET["id_contact"] .
                         "</p>";
                     $confirmation .=
                         "<a href=\"back.php?action=messagerie&cas=supprimer_message&id_contact=" .
                         $_GET["id_contact"] .
                         "\">OUI</a>&nbsp;&nbsp;&nbsp;";
                     $confirmation .=
                         "<a href=\"back.php?action=messagerie\">NON</a>";
                 }
     ...
     while ($ligne = mysqli_fetch_object($resultat)) {
         ...
         $content .=
             ...
             "</div>";
         $content .=
             "<div class=\"actions\"><a href=\"back.php?action=messagerie&cas=avertir_message&id_contact=" .
             $ligne->id_contact .
             "\"><span class=\"dashicons dashicons-no\"></span></a></div>";
         $content .= "</summary>";

         $content .=
             "<div class=\"all\">Nom : " .
             $ligne->prenom_contact .
             " " .
             $ligne->nom_contact .
             "<br><br>Message : " .
             $ligne->message_contact .
             "</div>";
