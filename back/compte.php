    ...
    switch ($_GET["cas"]) {
        case "inserer_compte":
            ...
            if (empty($_POST["nom_compte"])) {
                ...
                $confirmation =
                    "<p class=\"pas_ok\">Le statut est obligatoire</p>";}
        ...
        case "avertir_compte":
            if (isset($_GET["id_compte"])) {
                $confirmation = "<p class='ok'>Voulez-vous supprimer le compte n°" . $_GET["id_compte"] . "</p>";
                $confirmation .= "<a class='yes' href=\"back.php?action=compte&cas=supprimer_compte&id_compte=" . $_GET["id_compte"] . "\">OUI</a>&nbsp;&nbsp;&nbsp;";
                $confirmation .= "<a class='non' href=\"back.php?action=compte\">NON</a>";
            }
